import { Diagnosis, FixResult } from "../types.js";
...
export async function fixDiagnosis(diagnosis: Diagnosis, targetDir: string, progress?: Progress): Promise<FixResult> {
  ...
  if (details.kind === "env-file" || details.kind === "env-var") return syncEnvVar(details.kind, targetDir, details.key, details.value);
